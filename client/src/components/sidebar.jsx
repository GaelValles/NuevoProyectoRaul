    ...
    <div>
      ...
      <div className={`sidebar fixed top-0 bottom-0 left-0 lg:left-0 duration-1000 p-2 w-[300px] overflow-y-auto text-center bg-white shadow h-screen`}>
        <div className="text-black text-xl">
          ...
          <div className="p-2 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer">
            <Link to="/Calidad"><i className="bi bi-people-fill hover:text-blue-700"></i></Link>
            <Link to="/Calidad"><span className="text-[17px] ml-4 text-black hover:text-blue-700">Conductores</span></Link>
          </div>

          <div className="p-2 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer">
            <Link to="/Ph"><i className="bi bi-folder-fill hover:text-blue-700"></i></Link>
            <Link to="/Ph"><span className="text-[17px] ml-4 text-black hover:text-blue-700">Permisos</span></Link>
          </div>
