...
export const postCamiones = async (req, res) => {
    const { marca, modelo, color, placasMx, placasUsa, numEco, numSerie } = req.body;
  try {
    const newCamion = new Camion({ marca, modelo, color, placasMx, placasUsa, numEco, numSerie, user: req.user.id });
